...
def download_data():    
    ...
    return dataframes, file_name_to_number
...
def data_widget():
    ...
    dataframe_names = []  # This will be populated later
    ...
    # Populate uploaded_dataframes and dataframe_names using download_data()
    dataframes, file_name_to_number = download_data()  # Retrieve dataframes and file_name_to_number
    
    for data_name, number in file_name_to_number.items():
        dataframe_name = 'dataframe_' + number
        if dataframe_name in dataframes:  # Check if the dataframe exists
            uploaded_dataframes[data_name] = dataframes[dataframe_name]
            dataframe_names.append(data_name)
